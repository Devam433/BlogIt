    ...
    <section className='w-full  h-[590px] bg-[#ffffff] flex justify-center'>
        <div className='w-[1210px] flex justify-between items-center'>
            <div className='w-[600px] flex flex-col gap-4'>
                ...
                <Link to="/blogs"><button className='w-[189px] h-[60px] font-bold text-xl bg-[#FF5959] rounded-lg text-white outline-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]'>Explore</button>
                </Link>
            </div>
            <div className='w-[570px] relative flex justify-center items-center'>
                <img src={HeroImg} alt="" />
                <Link to="/login" className=' absolute'><button className='w-[189px] h-[60px] font-bold text-xl bg-[#FF5959] rounded-lg text-white outline-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]'>Login</button>
                </Link>
            </div>
        </div> 
    </section>
